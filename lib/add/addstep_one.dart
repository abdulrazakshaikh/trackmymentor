            ...
            child: Row(
              children: [
                Container(
                  ...
                  width: 42,
                  child: Image.asset(
                  index == 0 ? 'images/tutor.png' : 
                  index == 1 ? 'images/project.png' : 
                  index == 2 ? 'images/sports.png' : 
                  index == 3 ? 'images/coach.png' : 
                  index == 4 ? 'images/chart.png' : 
                  index == 5 ? 'images/model.png' : 
                  index == 6 ? 'images/activity.png' : 
                  index == 7 ? 'images/assignment.png' : 
                  'null',
                  fit: BoxFit.contain,
                  ),
                ),
