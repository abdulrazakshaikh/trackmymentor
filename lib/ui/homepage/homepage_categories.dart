          ...
          child: Row(
            ...
            children: [
             ...
             true? Container(): Container(
                child: TextButton(
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> SeeAllProjectList("Cat")));
                  },
                  child: Row(
                    children: [
                      Text('Show All',
            ...
            child: PageView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> SeeAllProjectList("${item['title']}")));
                    },
                      child: Card(
                        elevation: 5,
